...
AStarResult solve_A_star(
    ...
    if (heuristic_choice_id == 1)
        initial_h_cost = heuristic_misplaced_tiles(initial_board, goal_state);
    else if (heuristic_choice_id == 2)
        initial_h_cost = heuristic_manhattan_distance(initial_board, goal_state, grid_size, tile_to_goal);
    else if (heuristic_choice_id == 3)
        initial_h_cost = heuristic_linear_conflicts(initial_board, goal_state, grid_size, tile_to_goal);
    else if (heuristic_choice_id == 4)
        initial_h_cost = heuristic_pdb_plus_manhattan_remaining(initial_board, goal_state, grid_size, tile_to_goal, pdb_pattern_tiles, pdb);
